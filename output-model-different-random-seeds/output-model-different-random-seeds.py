...
text = None
with open(f'{base}{modelCharacteristic}.txt', 'r') as file:
    text = file.read()
...
with PdfPages(f'{base}{modelCharacteristic}_model_visualizations_based_on_output.pdf') as pdf:
...
print('\nSelected row (the one having the lowest loss from the Top 5 Accuracy): ', df.iloc[8], sep='\n')